...
const styles = StyleSheet.create({
  ...
  headline: { fontSize: 30, lineHeight: 34, letterSpacing: -1.2, color: colors.onInk },
  headlineCompact: { fontSize: 23, lineHeight: 26, letterSpacing: -0.8, color: colors.onInk },
  lede: { marginTop: 10, maxWidth: 300, fontSize: 14, lineHeight: 21, color: colors.onInkBody },
  field: { paddingTop: 16 },
  fieldLabel: { fontSize: 11, letterSpacing: 1.76, marginBottom: 2 },
  fieldRow: { flexDirection: 'row', alignItems: 'center', gap: 10, minHeight: 40 },
  fieldInput: { flex: 1, fontFamily: fonts.medium, fontSize: 17, letterSpacing: -0.2, color: colors.onInk, paddingVertical: 6, paddingHorizontal: 0 },
  ...
  primary: { height: 56, borderRadius: 16, paddingLeft: 22, paddingRight: 7, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, backgroundColor: colors.orange },
  primaryOff: { backgroundColor: 'rgba(228,98,10,0.35)' },
  pressed: { transform: [{ translateY: 1 }, { scale: 0.995 }] },
  primaryLabel: { flexShrink: 1, fontSize: 15.5, letterSpacing: -0.3, color: colors.orangeLabel },
  primaryTrail: { width: 42, height: 42, borderRadius: 13, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(23,20,15,0.22)' },
  outline: { height: 54, borderRadius: 16, borderWidth: 1, borderColor: colors.onInkBorder, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
  outlineTrailing: { height: 56, justifyContent: 'space-between', paddingLeft: 22, paddingRight: 7 },
  outlineTile: { width: 42, height: 42, borderRadius: 13, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(20,23,27,0.12)' },
  outlineLabel: { fontSize: 15, letterSpacing: -0.3, color: colors.onInk },
  ...
  digit: { fontFamily: fonts.medium, fontSize: 30, lineHeight: 36, letterSpacing: -1.1 },
  caret: { width: 2, height: 28, backgroundColor: colors.orange, marginBottom: 4 },
  ...
  checkTile: { width: 56, height: 56, borderRadius: 18, backgroundColor: colors.orange, alignItems: 'center', justifyContent: 'center' },
  ...
  googleTitle: { fontSize: 24, lineHeight: 27, letterSpacing: -0.9, color: colors.onInk, textAlign: 'center' },
