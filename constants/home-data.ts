...
export const POPULAR_SERVICES: Service[] = [
  {
    ...
    label: 'Electrical',
    tint: '#F59E0B',
    image: require('../assets/images/services/batch-1-core/electrical_maintenance_tools_and_symbols.webp'),
  },
  {
    id: 'plumbing',
    label: 'Plumbing',
    tint: '#3B82F6',
    image: require('../assets/images/services/batch-1-core/plumbing_tools_and_pipe_assembly.webp'),
  },
  {
    id: 'ac',
    label: 'AC Repair',
    tint: '#0EA5E9',
    image: require('../assets/images/services/batch-1-core/ac_repair_icon_with_cool_airflow.webp'),
  },
  {
    id: 'fridge',
    label: 'Fridge',
    tint: '#06B6D4',
    image: require('../assets/images/services/batch-1-core/refrigerator_and_repair_tools_icon.webp'),
  },
  {
    id: 'generator',
    label: 'Generator',
    tint: '#8B5CF6',
    image: require('../assets/images/services/batch-1-core/portable_generator_with_wrench_and_power_icon.webp'),
  },
  {
    id: 'solar',
    label: 'Solar',
    tint: '#F97316',
    image: require('../assets/images/services/batch-1-core/solar_panel_with_wrench_and_sun.webp'),
  },
  {
    id: 'painting',
    label: 'Painting',
    tint: '#EC4899',
    image: require('../assets/images/services/batch-1-core/paint_tools_in_vibrant_harmony.webp'),
  },
  {
    id: 'carpentry',
    label: 'Carpentry',
    tint: '#A16207',
    image: require('../assets/images/services/batch-1-core/woodworking_tools_on_wooden_plank.webp'),
  },
];
...
export const SERVICE_CATEGORIES: Service[] = [
  ...
  },
  {
    ...
    tint: '#14B8A6',
    image: require('../assets/images/services/batch-2-extra/washing_machine_with_tools_for_repair.webp'),
  },
  {
    id: 'cleaning',
    label: 'Cleaning',
    tint: '#22C55E',
    image: require('../assets/images/services/batch-1-core/shiny_cleaning_tools_on_display.webp'),
  },
  {
    id: 'welding',
    label: 'Welding',
    tint: '#EF4444',
    image: require('../assets/images/services/batch-1-core/welding_tools_and_sparks_in_motion.webp'),
  },
  {
    id: 'tiling',
    label: 'Tiling',
    tint: '#6366F1',
    image: require('../assets/images/services/batch-2-extra/tiling_tools_and_stacked_ceramic_tiles.webp'),
  },
  {
    id: 'roofing',
    label: 'Roofing',
    tint: '#0EA5E9',
    image: require('../assets/images/services/batch-2-extra/roof_repair_tools_in_sleek_3d.webp'),
  },
  {
    id: 'security',
    label: 'CCTV & Security',
    tint: '#64748B',
    image: require('../assets/images/services/batch-2-extra/security_camera_with_tools_setup.webp'),
  },
  {
    id: 'pest-control',
    label: 'Pest Control',
    tint: '#16A34A',
    image: require('../assets/images/services/batch-2-extra/pest_control_shield_and_spray_can.webp'),
  },
  {
    id: 'locksmith',
    label: 'Locksmith',
    tint: '#CA8A04',
    image: require('../assets/images/services/batch-2-extra/lock_and_wrench_repair_tools.webp'),
  },
  {
    id: 'electronics',
    label: 'Electronics',
    tint: '#3B82F6',
    image: require('../assets/images/services/batch-2-extra/laptop_and_phone_repair_tools_icon.webp'),
  },
  {
    id: 'satellite',
    label: 'Satellite & TV',
    tint: '#0891B2',
    image: require('../assets/images/services/batch-2-extra/satellite_dish_installation_with_tools.webp'),
  },
  {
    id: 'plastering',
    label: 'Plastering',
    tint: '#A16207',
    image: require('../assets/images/services/batch-2-extra/ceiling_panel_and_plastering_tools_set.webp'),
  },
  {
    id: 'water-pump',
    label: 'Water Pumps',
    tint: '#2563EB',
    image: require('../assets/images/services/batch-2-extra/mechanical_pump_and_wrench_icon.webp'),
  },
  {
    id: 'vulcanizer',
    label: 'Vulcanizer',
...
export const NEARBY_ARTISANS: Artisan[] = [
  {
    ...
    available: true,
    accent: '#F97316',
    avatar: require('../assets/images/artisans/avatars/friendly_electrician_with_cable_coil.webp'),
    cover: require('../assets/images/artisans/working/hero_electrician.webp'),
    reviews: 124,
    experienceYears: 6,
    ...
    gallery: [
      require('../assets/images/artisans/working/hero_electrician.webp'),
      require('../assets/images/artisans/working/hero_ac.webp'),
      require('../assets/images/artisans/working/hero_fridge.webp'),
      require('../assets/images/artisans/working/hero_carpenter.webp'),
    ],
  },
  {
    id: 'ibrahim-yusuf',
    ...
    available: true,
    accent: '#3B82F6',
    avatar: require('../assets/images/artisans/avatars/confident_plumber_with_red_wrench.webp'),
    cover: require('../assets/images/artisans/working/hero_plumber.webp'),
    reviews: 98,
    experienceYears: 8,
    location: 'Lagos, Nigeria',
    responseTime: '10 min',
    ...
    gallery: [
      require('../assets/images/artisans/working/hero_plumber.webp'),
      require('../assets/images/artisans/working/hero_fridge.webp'),
      require('../assets/images/artisans/working/hero_electrician.webp'),
      require('../assets/images/artisans/working/hero_carpenter.webp'),
    ],
  },
  {
    ...
    available: false,
    accent: '#10B981',
    avatar: require('../assets/images/artisans/avatars/hvac_technician_portrait_in_uniform.webp'),
    cover: require('../assets/images/artisans/working/hero_ac.webp'),
    reviews: 76,
    experienceYears: 5,
...
export const SAMPLE_REVIEWS: Review[] = [
  {
    ...
    avatar: require('../assets/images/artisans/avatars/professional_artisan_portrait_with_uniform.webp'),
  },
  {
    id: 'r2',
    name: 'Tunde O.',
    ...
    avatar: require('../assets/images/artisans/avatars/professional_handyman_with_tools.webp'),
  },
  {
    id: 'r3',
    name: 'Ngozi E.',
    ...
    avatar: require('../assets/images/artisans/avatars/appliance_repair_expert_portrait.webp'),
  },
];
