...
export const NEARBY_ARTISANS: Artisan[] = [
  {
    ...
    cover: require('../assets/images/artisans/working/hero_electrician.png'),
    reviews: 124,
    experienceYears: 6,
    ...
    gallery: [
      require('../assets/images/artisans/working/hero_electrician.png'),
      require('../assets/images/artisans/working/hero_ac.png'),
      require('../assets/images/artisans/working/hero_fridge.png'),
      require('../assets/images/artisans/working/hero_carpenter.png'),
    ],
  },
  {
    id: 'ibrahim-yusuf',
    ...
    cover: require('../assets/images/artisans/working/hero_plumber.png'),
    reviews: 98,
    experienceYears: 8,
    location: 'Lagos, Nigeria',
    responseTime: '10 min',
    ...
    gallery: [
      require('../assets/images/artisans/working/hero_plumber.png'),
      require('../assets/images/artisans/working/hero_fridge.png'),
      require('../assets/images/artisans/working/hero_electrician.png'),
      require('../assets/images/artisans/working/hero_carpenter.png'),
    ],
  },
  {
    ...
    cover: require('../assets/images/artisans/working/hero_ac.png'),
    reviews: 76,
    experienceYears: 5,
...
export const WORKING_ARTISANS: WorkingArtisan[] = [
  {
    id: 'plumber',
    service: 'Plumbing',
    image: require('../assets/images/artisans/working/hero_plumber.png'),
  },
  {
    id: 'electrician',
    service: 'Electrical',
    image: require('../assets/images/artisans/working/hero_electrician.png'),
  },
  {
    id: 'hvac',
    service: 'AC Repair',
    image: require('../assets/images/artisans/working/hero_ac.png'),
  },
  {
    id: 'fridge',
    service: 'Fridge Fix',
    image: require('../assets/images/artisans/working/hero_fridge.png'),
  },
  {
    id: 'carpenter',
    service: 'Carpentry',
    image: require('../assets/images/artisans/working/hero_carpenter.png'),
  },
];
